export const metadata = {
  ...
  keywords: 'fjrodafo, website, portfolio, cv, curriculum, vitae, linkedin, github, gitlab, bitbucket, docker, dockerhub, node, nodejs, npm, npmjs, git, html, css, javascript, typescript, react, next, nextjs, vercel, about, contact, home, projects, qualification, services, skills, testimonials, translation, english, spanish, japanese, light, theme, dark, mode',
};
