...
const Utilities = () => {
  ...
  return (
    <div className='home__utilities'>
      <a href='https://www.linkedin.com/in/fjrodafo' className='home__utilities-icon' target='_blank' rel='noreferrer' aria-label='LinkedIn'>
      ...
      <a href='https://github.com/FJrodafo' className='home__utilities-icon' target='_blank' rel='noreferrer' aria-label='GitHub'>
      ...
      <button className='home__theme-icon' onClick={handleToggleTheme} aria-label={theme === 'light' ? t('home.dark') : t('home.light')}>
        {theme === 'light' ? (
      ...
      <button className='home__language-icon' onClick={handleToggleLanguage} aria-label={t('home.translate')}>
